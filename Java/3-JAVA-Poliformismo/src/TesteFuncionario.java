...
public class TesteFuncionario {
	...
	public static void main(String[] args) {
		...
		Funcionario rafael = new Funcionario(); //Criar o objeto 'rafael' do tipo 'Funcionario' que está descrito no arquivo 'Funcionario'
		...
		System.out.println(rafael.getSalario()); //imprimir o salario atual setado pelo 'set' acima
		System.out.println(rafael.getBonificacao()); //imprimindo a bonificação depois de setar o salario, bonificação é um calculo
		System.out.println(rafael.getSalario() + rafael.getBonificacao()); //imprimindo o salario depois de adicionar a bonificação
	}
}
