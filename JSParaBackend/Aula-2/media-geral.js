...
// function media(notasGeral){
//     const somaGeral = notasGeral.reduce((acum, atual) => atual + acum, 0)
//     return somaGeral / notasGeral.length
// }
// console.log(`Media geral: ${media(notas)}`)


//outro jeito de fazer o de cima
// const notas = [10, 6.5, 8, 7]
